...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>/public/app-assets/css-rtl/plugins/forms/form-validation.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>/public/app-assets/css-rtl/pages/authentication.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
            ...
            <div class="content-body">
                ...
                <?php endif;?>
                                <a href="index.html" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ms-1">Wedo</h2>
                                </a>

                                <h4 class="card-title mb-1">Welcome to Wedo</h4>
                                <p class="card-text mb-2">Please sign-in to your account and start the adventure</p>

                                <form class="auth-login-form mt-2" id="loginForm" name="loginForm" action="<?php echo base_url().'/admin/authenticate'?>" method="POST">
                                    <div class="mb-1">
    ...
    <script src="<?=base_url()?>/public/app-assets/vendors/js/forms/validation/jquery.validate.min.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?=base_url()?>/public/app-assets/js/scripts/pages/auth-login.js"></script>
    <!-- END: Page JS-->
